...
31 个内置类型，每个都有中文锚点示例。看它们长什么样：打开[在线画廊](https://patrick-xin.github.io/diagram-design-zh/)一次翻完；已安装或已克隆的，浏览器直接开技能目录下的 `assets/index.html`，一样。

| 分组         | 类型                                                                                                                |
| ------------ | ------------------------------------------------------------------------------------------------------------------- |
| 系统与流程   | 架构图 · 流程图 · 时序图 · 状态机 · ER / 数据模型 · 数据库 schema · 数据流 · 流程 · 泳道 · 组织架构 · 树形 · 嵌套 · 分层 · 鱼骨图  |
| 计划与叙事   | 时间线 · 甘特 · 象限 · 飞轮 · 金字塔 / 漏斗 · 维恩                                                                  |
| 数据图表     | 柱状 · 折线 · 散点 · 雷达 · 矩形树图                                                                                |
| 数据平台特化 | 数据栈全景 · 奖章架构 · IT 现状 · 数据平台集成 · 安全矩阵                                                           |
| 待中文化     | 桑基图 · Wardley 地图 · 用户旅程 · 部署图 · 依赖图 · UML 类图 · 故事地图 · 极坐标图                     |
