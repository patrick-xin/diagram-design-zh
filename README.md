...
39 个内置类型，每个都有中文锚点示例。看它们长什么样：打开[在线画廊](https://patrick-xin.github.io/diagram-design-zh/)一次翻完；已安装或已克隆的，浏览器直接开技能目录下的 `assets/index.html`，一样。
...
| 数据图表     | 柱状 · 折线 · 散点 · 雷达 · 极坐标图 · 桑基图 · 矩形树图                                                             |
