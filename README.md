...
28 个内置类型，每个都有中文锚点示例。看它们长什么样：打开[在线画廊](https://patrick-xin.github.io/diagram-design-zh/)一次翻完；已安装或已克隆的，浏览器直接开技能目录下的 `assets/index.html`，一样。
...
| 待中文化     | 桑基图 · 鱼骨图 · Wardley 地图 · 看板 · 用户旅程 · 部署图 · 依赖图 · UML 类图 · 故事地图 · 数据库 schema · 极坐标图 |
